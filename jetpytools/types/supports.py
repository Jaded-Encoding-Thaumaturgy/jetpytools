...
class ComparatorFunc(Protocol):
    @overload
    def __call__(
        self, arg1: SupportsRichComparisonT, arg2: SupportsRichComparisonT, /,
        *args: SupportsRichComparisonT, key: None = ...
    ) -> SupportsRichComparisonT:
        ...
    ...
    @overload
    def __call__(self, iterable: Iterable[SupportsRichComparisonT], /, *, key: None = ...) -> SupportsRichComparisonT:
        ...
